export class AudioManager {
  ...
  public stopAll() {
    // 1. Stop Web Audio (Gemini/Storyteller)
    ...
    // 2. Stop Synthesis (Mechanical Voice)
    if (this.synthesis) {
  ...
  public async playGeminiAudio(base64Audio: string): Promise<AudioBufferSourceNode> {
    ...
    const buffer = ctx.createBuffer(1, float32Array.length, 24000); // Gemini usually 24k
  ...
  public playTTS(text: string) {
    ...
    // Intelligent Voice Selection for "Human-like" quality
